### Initialises _ComRingTraceIndets, _ConicAlgTraces, _TrSubIndetList and _TrSubValueList.
### The list _ComRingIndetInfo and the dict _TrDict are not initialised here because
### _InitTrDict has to be called before ComRing is defined.
